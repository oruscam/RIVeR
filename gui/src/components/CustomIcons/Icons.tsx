...
export const Icons = {
  Eye: (c?: string) => (
    <I color={c} d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7z" extra={['M12 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6z']} />
  ),
  EyeOff: (c?: string) => (
    <I
      color={c}
      ...
      extra={[
        ...
        'M1 1l22 22',
        'M10.73 10.73a3 3 0 0 0 4.2 4.2',
      ]}
    />
  ),
  Lock: (c?: string) => (
    <I
      ...
      extra={['M7 11V7a5 5 0 0 1 10 0v4']}
    />
  ),
  Unlock: (c?: string) => (
    <I
      color={c}
      d="M19 11H5a2 2 0 0 0-2 2v7a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7a2 2 0 0 0-2-2z"
      extra={['M7 11V7a5 5 0 0 1 9.9-1']}
    />
  ),
  Copy: (c?: string) => (
    <I
      color={c}
      d="M8 17.929H6c-1.105 0-2-.912-2-2.036V5.036C4 3.91 4.895 3 6 3h8c1.105 0 2 .911 2 2.036v1.866"
      extra={['M18 21H10a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2z']}
    />
  ),
  Check: (c?: string) => <I color={c} d="M20 6L9 17l-5-5" />,
  Trash: (c?: string) => (
    <I color={c} d="M3 6h18M8 6V4h8v2M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6M10 11v6M14 11v6" />
  ),
  BoxSel: (c?: string) => (
    <svg
      width={21}
    ...
    >
      ...
      <path d="M5 21H3v-2" />
      <path d="M19 21h2v-2" />
      <path strokeDasharray="3 3" d="M3 9v6M21 9v6M9 3h6M9 21h6" />
    </svg>
  ),
  Pincel: (c?: string) => (
    <I
  ...
  PincelCrossed: (c?: string) => (
    <I
      color={c}
      d="m10 10-6.157 6.162a2 2 0 0 0-.5.833l-1.322 4.36a.5.5 0 0 0 .622.624l4.358-1.323a2 2 0 0 0 .83-.5L14 13.982"
      extra={['m12.829 7.172 4.359-4.346a1 1 0 1 1 3.986 3.986l-4.353 4.353', 'm2 2 20 20']}
    />
  ),
  Globe: (c?: string) => (
    <I
  ...
  Settings: (c?: string) => (
    <I
      ...
      extra={['M12 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6z']}
    />
  ),
  ChevDown: (c?: string, rot?: number) => (
    <svg
      width={13}
      height={13}
      viewBox="0 0 24 24"
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      style={{ transform: `rotate(${rot || 0}deg)`, transition: 'transform .2s' }}
    >
      <path d="M6 9l6 6 6-6" />
    </svg>
  ),
  ...
  Video: (c?: string) => (
    <I
      color={c}
      d="m22 8-6 4 6 4V8Z"
      extra={['M4 6h10a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2z']}
    />
  ),
  Loader: (c?: string) => (
  ...
  SoundOn: (c?: string) => (
    <I
      ...
      extra={['M16 9a5 5 0 0 1 0 6', 'M19.364 18.364a9 9 0 0 0 0-12.728']}
    />
  ),
  SoundOff: (c?: string) => (
    <I
  ...
  Ruler: (c?: string) => (
    <I
      ...
      extra={['m14.5 12.5 2-2', 'm11.5 9.5 2-2', 'm8.5 6.5 2-2', 'm17.5 15.5 2-2']}
    />
  ),
  Sun: (color?: string) => (
    <svg
