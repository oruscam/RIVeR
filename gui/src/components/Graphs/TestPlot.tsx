...
export const TestPlot = () => {
    ...
    const graphWidth = screenWidth * GRAPHS.PLOT_TEST_PROPORTION > GRAPHS.MIN_WIDTH ? screenWidth * GRAPHS.PLOT_TEST_PROPORTION : GRAPHS.MIN_WIDTH
    ...
    return (
        <div>
            {
                quiver && (<svg ref={svgRef} width={graphWidth} height={graphWidth * 0.8} id="quiver-test-plot"/>)
            }
        </div>
    )
}