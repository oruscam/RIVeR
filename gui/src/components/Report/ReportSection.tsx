    ...
    <div id='report-section-container'>
      <div id='report-section-top-container'>
        ...
        <div id='report-section-top-left-container'>
            ...
            <h3 id="report-section-discharge-label"> {t('Report.dischargeQ')} {total_Q}  m&sup3;/s  (&plusmn; {total_q_std.toFixed(2)} m&sup3;/s)</h3>
            <h4 className="mt-1"> { measured_Q * 100 }% {t('Report.section.measured')} </h4>
            <h4> { interpolated_Q * 100 } % {t('Report.section.interpolated')} </h4>
            <h3 className="mt-2 report-section-title-1"> {t('Report.section.alpha')} { alpha } </h3>
            <h3 className="mt-1 report-section-title-1 mb-2"> {t('Report.section.stationNumber')} { num_stations } </h3>
