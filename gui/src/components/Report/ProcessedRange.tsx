...
export const ProcessedRange = () => {
  ...
  return (
    <>
      <h2 className="report-title-field mt-2">
        {t("Report.ProcessedRange.title")}
      </h2>
      <div id="report-processed-range-container">
        <div className="report-grid-1">
          <div className="report-info-item">
            <span>{t("Report.ProcessedRange.start")}</span>
          </div>
          <div className="report-info-item">
            <span>{t("Report.ProcessedRange.end")}</span>
          </div>
          <div className="report-info-item">
            <span>{t("Report.ProcessedRange.length")}</span>
          </div>
          <div className="report-info-item">
            <span>{t("Report.ProcessedRange.step")}</span>
          </div>
          <div className="report-info-item">
            <span>{t("Report.ProcessedRange.timeStep")}</span>
          </div>
          <div className="report-info-item">
          ...
          <div className="report-info-item">
            <span> {timeProcessed}s </span>
          </div>
          <div className="report-info-item">
            <span> {step} </span>
          </div>
          <div className="report-info-item">
            <span> {timeBetweenFrames}ms </span>
          </div>
        </div>
        ...
        <div id="report-carousel">
          <img
            src={paths[0]}
            alt="First frame"
            className="report-carousel-img"
            id="first-img-carousel"
          />
          <img
            src={paths[firstQuarter]}
            alt="First frame"
            className="report-carousel-img"
          />
          <img
          ...
          <img
            ...
            alt="First frame"
            className="report-carousel-img"
            id="last-img-carousel"
          />
        </div>

        <div id="report-carousel-footer">
          <p className="report-carousel-footer-item">
            {" "}
          ...
          <p className="report-carousel-footer-item">
            {" "}
            {formatTime(frameTime * 2)}
          </p>
          <p className="report-carousel-footer-item">
            {" "}
            {formatTime(frameTime * 3)}
          </p>
