    ...
    <>
        ...
        <div id='report-video-info-container'>
          <div className='report-grid-1'>
            <div className='report-info-item'><span>{t('Report.VideoInfo.name')}</span></div>
            <div className='report-info-item'><span>{t('Report.VideoInfo.duration')}</span></div> 
            <div className='report-info-item'><span>{t('Report.VideoInfo.resolution')}</span></div> 
            <div className='report-info-item'><span>{t('Report.VideoInfo.fps')}</span></div> 
            <div className='report-info-item'><span>{t('Report.VideoInfo.creationDate')}</span></div> 
