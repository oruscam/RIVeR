...
const transformData = (data: any, all: boolean): any => {
    ...
    for (const key in data) {
        ...
        result[key] = {
            ...
            total_Q: section.total_Q !== undefined ? parseFloat(section.total_Q.toFixed(2)) : null,
            measured_Q: section.measured_Q !== undefined ? parseFloat(section.measured_Q.toFixed(2)) : null,
